...
namespace PhoneCompanyBillingSystem
{
    class Program
    {
            ...
            while (tryAgain == 'Y')
            {
                ...
                switch (packageChoice)
                {
                    ...
                    case 'C':
                        ...
                        break;
                    default:
                        Console.WriteLine("Invalid package choice. Please choose A, B, or C.");
                        continue;
                }
        ...
        static void PrintBillToFile()
        {
            // Retrieve customer details
            Console.WriteLine("\nPrinting bill to file...");

            // Retrieve bill details
            string billDetails = ""; // Replace with actual bill details

            // Write to file
            string filePath = "MyBill.txt";
            File.WriteAllText(filePath, billDetails);

            Console.WriteLine("Bill printed to " + filePath);
        }
    }
}
